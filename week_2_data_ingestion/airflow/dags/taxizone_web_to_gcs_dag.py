...
dataset_file = "taxi+_zone_lookup_{{ execution_date.strftime(\'%Y-%m\') }}.csv"
...
with DAG(
    dag_id="taxi_zone_lookup_dag_v001",
    ...
    download_dataset_task >> format_to_parquet_task >> local_to_gcs_task >> remove_local_file
